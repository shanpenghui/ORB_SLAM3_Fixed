#!/bin/bash
pathDatasetEuroc='/media/sph/TOSHIBA EXT/dataset' #Example, it is necesary to change it by the dataset path
...
./Examples/Monocular/mono_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular/EuRoC.yaml "$pathDatasetEuroc"/MH_03_medium ./Examples/Monocular/EuRoC_TimeStamps/MH03.txt dataset-MH03_mono
