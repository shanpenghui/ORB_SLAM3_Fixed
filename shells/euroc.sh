...
if  [ -f "$currentDir/Examples/Monocular-Inertial/EuRoC.yaml" ];then
  echo  ""
else
  echo  "该文件不存在 $currentDir/Examples/Monocular-Inertial/EuRoC.yaml "
  exit 1
fi
...
if  [ -f "$currentDir/Examples/Monocular-Inertial/EuRoC_TimeStamps/MH01.txt" ];then
  echo  ""
else
  echo  "该文件不存在 $currentDir/Examples/Monocular-Inertial/EuRoC_TimeStamps/MH01.txt "
  exit 1
fi
if  [ -d "logs" ];then
  echo  ""
